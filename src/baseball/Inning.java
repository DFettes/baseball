...
public class Inning {
	static String[] results = new String[30];
	static String[] runResults = new String[30];
	static int[] runs = new int[30];
	static int[] outs = new int[30];
	static int[][] bases = new int[30][3];
	...
	public static int[] NewInning(Team t1, Team t2, int BatterUp, int pitcher, boolean homeChance, int homeDef){
		...
		while (outs < 3){
			...
			*/
			...
			setScore(runsBatter[0], i);
			setOuts(outs, i);
			setResult(result, i);
			//setRunResult(runResult, i);
			setBases(run1b, run2b, run3b, i);
			i++;
	...
	public static void setResult(String resultString, int i){
	...
	public static void setRunResult(String runResultString, int i){
		runResults[i] = runResultString;
	}
	
	public static String getRunResult(int i){
		return runResults[i];
		
	}
	
	public static void setScore(int run, int i){
		runs[i] = run;
	}
	...
	public static void setOuts(int out, int i){
		outs[i] = out;
	}

	public static int getOuts(int i){
		return outs[i];
	}
	
	public static void setBases(Player run1b, Player run2b, Player run3b, int i){
		if (run1b != null){
			bases[i][0] = 1;
		}
		else bases[i][0] = 0;
	...
	public static int[] getBases(int i){
		return bases[i];
	}
